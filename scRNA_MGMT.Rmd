...
CPTAC_tumor_seurat$MGMTe <- ifelse(MGMTe > 0.1, "MGMT+", "MGMT-")  
...
Neftel_tumor_seurat$MGMTe <- ifelse(MGMTe > 0.1, "MGMT+", "MGMT-")  
...
MGMT expression ranged from 0-1.26% in the MGMTp methylated group (median 0.59%), and from 0.3-27.67% in the MGMTp unmethylated group (median 12.44%).
...
Wang_tumor_seurat$MGMTe <- ifelse(MGMT_Wang > 0.1, "MGMT+", "MGMT-")
rm(MGMT_Wang)
...
ZH1019_T1_seurat_obj$MGMTe <- ifelse(MGMT_ZH1019_T1 > 0.1, "MGMT+", "MGMT-")
...
ZH1007_inf_seurat_obj$MGMTe <- ifelse(MGMT_ZH1007_inf > 0.1, "MGMT+", "MGMT-")
